...
// use \Application\Block\Form\MiniSurveyA;
...
<form enctype="multipart/form-data" class="form-stacked miniSurveyView" id="miniSurveyView<?php  echo $bID; ?>" method="post" action="<?php  echo $formAction ?>">
	...
	<div class="fields">
		...
		<?php  foreach ($questions as $question): ?>
			<div class="form-group width-size <?php echo isset($errorDetails[$question['msqID']]) ? 'has-error' : ''?>">
				<label class="control-label form-size" <?php  echo $question['labelFor']; ?>>
	...
	<div class="btn-positon">
		<input type="submit" name="Submit" class="go-btn" value="<?php  echo h(t($survey->submitText)); ?>" />
	</div>
