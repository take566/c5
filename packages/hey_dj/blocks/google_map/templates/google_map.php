...
<?php  } else { ?>
	...
	<p class="maps"><a href="https://www.google.co.jp/maps/place/<?php echo urlencode($location);?>/@<?php echo urlencode($latitude);?>,<?php echo urlencode($longitude);?>,15z" target="_blank"><?php echo t('View this map in a new window');?></a></p>
<?php  } ?>
