                ...
                <div class="store-product-details col-md-12">
                    ...
                    <?php if ($showProductName) {
                        ...
                        <h2 class="store-product-name"
                            itemprop="name"><?= $csm->t($product->getName(), 'productName', $product->getID()); ?></h2>
                    ...
                    <?php if ($showProductPrice && !$product->allowCustomerPrice()) {
                        ...
                        ?>
                        <p class="store-product-price text-bold" data-price="<?= $activePrice; ?>" data-original-price="<?= $salePrice ? $price : ''; ?>" data-list-price="<?= ($isWholesale && $wholesalePrice) ? $price : ''; ?>"
                ...
                <?php if ($showImage) {
                    ...
                    <div class="store-product-image col-md-6">
                        ...
                        if (is_object($imgObj)) {
                            ...
                            ?>
                            <div class="store-product-primary-image margin-bottom-20">
