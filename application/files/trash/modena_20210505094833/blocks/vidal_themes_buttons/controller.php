<?php  namespace Concrete\Package\Modena\Block\VidalThemesButtons;
...
{
    public $btFieldsRequired = ['buttonType', 'buttonColors'];
    protected $btExportPageColumns = ['buttonUrl'];
    protected $btTable = 'btVidalThemesButtons';
    ...
    {
        return t("Add attractive buttons in multiple styles.");
    }
    ...
    public function view()
    {
        ...
        $buttonPosition_options = array(
            '' => "-- " . t("None") . " --",
            'text-left' => t("Align Left"),
            'text-right' => t("Align Right"),
            'text-center' => t("Center")
        );
        $this->set("buttonPosition_options", $buttonPosition_options);
    ...
    protected function addEdit()
    {
        ...
        $this->set("buttonPosition_options", array(
                '' => "-- " . t("None") . " --",
                'text-left' => t("Align Left"),
                'text-right' => t("Align Right"),
                'text-center' => t("Center")
    ...
    public function validate($args)
    {
        ...
        if ((in_array("buttonColors", $this->btFieldsRequired) && (!isset($args["buttonColors"]) || trim($args["buttonColors"]) == "")) || (isset($args["buttonColors"]) && trim($args["buttonColors"]) != "" && !in_array($args["buttonColors"], ["primary", "secondary", "tertiary", "utility-1", "utility-2", "warning", "success", "danger", "1", "2"]))) {
