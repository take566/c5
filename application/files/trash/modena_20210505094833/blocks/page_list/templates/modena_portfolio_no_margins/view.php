...
<?php else: ?>
    ...
    <div class="ccm-block-page-list-wrapper">
        ...
        <div class="isotope-items no-margin" data-isotope='{ "itemSelector": ".isotope-item", "layoutMode": "masonry" }'>
            ...
            foreach ($pages as $page) :
                ...
                if (is_object($thumbnail) && $includeEntryText) {
                    $entryClasses = 'isotope-item no-margin'." ".$output_tax." ".$isotope_columns;
                }
                            ...
                            <?php if ($includeEntryText) : ?>
                                <span class="overlay__content-heading">
                                    ...
                                    <?php if (isset($includeDate) && $includeDate) : ?>
                                        <span class="overlay__content-date"><?php echo h($date) ?></span>
                                    <?php endif; ?>
                                </span>
