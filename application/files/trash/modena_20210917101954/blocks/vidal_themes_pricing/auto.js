Concrete.event.bind('btVidalThemesPricing.packageItems.edit.open', function (options, settings) {
...
Concrete.event.bind('vidal_themes_pricing.buttonIcons.font_awesome', function () {
