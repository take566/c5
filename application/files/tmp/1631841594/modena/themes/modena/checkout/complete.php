...
<div class="grid-container margin-bottom-100">
    <div class="grid-row">
         <div class="column-12">

            <div class="store-order-complete-page test">

                <h4><?= t("Order #%s has been placed", $order->getOrderID()); ?></h4>
