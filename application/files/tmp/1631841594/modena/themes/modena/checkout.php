...
<div class="grid-container padding-bottom-100">
    <div class="grid-row">
...
<?php if ($controller->getAction() == "view" || $controller->getAction() == "failed") { ?>
    ...
    <div class="store-checkout-form-row row">
        ...
        <div class="store-checkout-form-shell col-md-7 clearfix">
        ...
        <div class="store-checkout-cart-view col-md-4 offset-1">
            <div class="store-checkout-cart-contents">
                ...
                <ul class="list margin-top-20 store-checkout-totals-line-items list-group">
                ...
                <ul class="list margin-top-5 store-checkout-totals-line-items list-group">
                ...
                <ul class="list margin-top-5 store-checkout-totals-line-items list-group" id="store-taxes">
                    <?php
                    if ($taxtotal > 0) {
